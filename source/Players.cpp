...
///
void Player::Update(float deltaTime, sf::Vector2f ballPos) noexcept {
...
///
void Player::Move(float deltaTime) noexcept {
...
///
void Player::AIMove(float deltaTime, sf::Vector2f ballPos) noexcept {
